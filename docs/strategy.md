...
- Seit AP23 kommen Universe-Mitglieder aus `universe_members`, wenn der
  Provider DB-Mitgliedschaften anbietet; Strategien erhalten weiterhin nur die
  daraus abgeleitete interne Tickerliste.
